            ...
            <div class="pointer-events-auto flex flex-col gap-4 p-4 min-w-[320px] max-w-sm bg-content border border-subtle rounded-2xl shadow-lg animate-fade-in-up">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex flex-col gap-1">
                        <h3 class="text-sm font-bold text-head italic tracking-tight">Update Available</h3>
                ...
                <div class="flex gap-2">
                    <Button color='primary' size='lg' class="flex-1 shadow-lg shadow-brand/30" onClick={props.onUpdate}>
                        Reload Now
                    </Button>
