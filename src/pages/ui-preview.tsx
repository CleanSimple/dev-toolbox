    ...
    return (
        <div class="w-full flex flex-col items-center gap-5">
            ...
            <div class="flex flex-row items-start flex-wrap">
                ...
                <div class="flex flex-col">
                    <span class="bg-brand-subtle hover:bg-brand-hover text-on-brand px-2">brand (subtle)</span>
                    <span class="bg-brand hover:bg-brand-hover text-on-brand px-2">brand (normal)</span>
                    <span class="bg-brand-strong hover:bg-brand-hover text-on-brand px-2">brand (strong)</span>
                </div>
                <div class="flex flex-col">
                    <span class="bg-accent-subtle hover:bg-accent-hover text-on-accent px-2">accent (subtle)</span>
                    <span class="bg-accent hover:bg-accent-hover text-on-accent px-2">accent (normal)</span>
                    <span class="bg-accent-strong hover:bg-accent-hover text-on-accent px-2">accent (strong)</span>
                </div>
            </div>
                ...
                {(size) => (
                    <div class="flex flex-row gap-5">
                        <For each={["primary", "secondary", "neutral"] as const}>
                            {(color) => (
                                <Button color={color} size={size}>Button</Button>
                            )}
                        </For>
